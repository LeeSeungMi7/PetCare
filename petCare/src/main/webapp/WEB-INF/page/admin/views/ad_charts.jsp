                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header" style="white-space:nowrap">
                                ...
                                <div class="dateselect">
                                    날짜 선택 :
                                    <input type="text" id="datepicker1" class="datepick">&nbsp;&nbsp;&nbsp;~&nbsp;&nbsp;
                                    <input type="text" id="datepicker2" class="datepick">
                                </div>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card mb-4">
                            <div class="card-header" style="white-space:nowrap">
                                ...
                                <div>
                                    날짜 선택 : 
                                    <input type="text" id="datepicker3" class="datepick">&nbsp;&nbsp;&nbsp;~&nbsp;&nbsp;
                                    <input type="text" id="datepicker4" class="datepick">
                                </div>
                            </div>
