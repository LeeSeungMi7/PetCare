				...
				<div class="pet-body pet-home">
					...
					<form onsubmit=" return fn_submit();" method="post" action="/partner_modify.do" enctype="multipart/form-data">
	                        ...
	                        <div class="join-user__items">
	                            <label>병원 이름</label>
	                            <input type="text" id="user_name" oninput="onInputInvalid('name')" name="m_name" value="${member.m_name}" readonly="readonly" required/>
	                            <span class="error_next_box" id="error_name" aria-live="assertive">병원 이름은 수정 불가능합니다</span>
	                        </div>
	                    ...
	                    <input type="hidden" id="p_24hour" name="p_24hour" value="0">
	                            	...
	                            	<button class="button_class buttonOk deleteMember">탈퇴</button>
	                            </div>
	                        </div>
	                    </div>
	                    <input type="hidden" name="emailcheck" value="0">
...
<script type="application/javascript" src="/resources/js/user/hos_update.js"></script>
