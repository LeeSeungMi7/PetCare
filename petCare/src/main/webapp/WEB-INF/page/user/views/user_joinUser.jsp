...
<head>
	  ...
	  function petsubmit() {
	      if (invalids.all()) {
	          ...
	          var queryString = $("form[name=petModal]").serialize();	
	      		alert(queryString);
	   ...
	   <body>
			            ...
			            <div class="join-user__items">
			                ...
			                <ul class="list-group">
			                    <li class="list-group-item active" aria-current="true">반려동물 등록
			                        <button class="addList" data-bs-toggle="modal" data-bs-target="#exampleModal">추가</button>
			                    </li>
			                    <li class="list-group-item">
			
			                        <div class="mypet_box1">
			                            <div id="petdetail">이름 : 구름이</div>
			...
			<form name="petModal" id="petMedal">
				    ...
				    <div class="modal-dialog">
				        <div class="modal-content">
				            ...
				            <div class="modal-body">
				                ...
				                <div class="join-user__items">
				                    <label>반려동물 이름</label>
				                    <input type="text" id="pet_name" oninput="onInputInvalids('pet')" name="mp_petName" />
				                ...
				                <div class="join-user__items">
				                    ...
				                    <input id="user_animal" type="text" maxlength="20" placeholder="예) 강아지, 고양이"
				                        oninput="onInputInvalids('animal')" name="mp_petType"/>
				                ...
				                <div class="join-user__items">
				                    ...
				                    <div class="join-user__items--row" style="justify-content: space-between">
				                        <input id="user_old" type="text" maxlength="5" oninput="onInputInvalids('old')"
				                            style="padding-right: 40px;" name="mp_petAge" >
				                        살
				                    </div>
				                ...
				                <div class="join-user__items">
				                    <label>성별</label>
				                    <div class="join-user__items--row" style="justify-content: space-between">
				                        <input type="radio" name="mp_petGender" value="0" checked="checked" /> 수컷입니다.
				                        <input type="radio" name="mp_petGender" value="1" /> 암컷입니다.
				                    </div>
				                </div>
				                <!--중성화수술은 했나요?-->
				                <div class="join-user__items">
				            ...
				            <div class="modal-footer">
				                ...
				                <button type="button" class="btn btn-success" onclick="petsubmit()">추가</button>
