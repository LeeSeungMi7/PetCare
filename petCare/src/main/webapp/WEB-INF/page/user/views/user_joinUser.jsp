...
<head>
	...
	<script>
	    $('a[href="#petadd"]').click(function(event) {
				...
				<div class="join-user" style="align-items: center">
					...
					<div class="join-user__items">
						<label>이름</label> <input type="text" id="user_name"
							oninput="onInputInvalid('name')" /> <span class="error_next_box"
							id="error_name" aria-live="assertive"></span>
					</div>
					...
					<div class="join-user__items">
						<label>비밀번호</label> <input id="user_password" type="password"
							...
							oninput="onInputInvalid('password')"> <input
							id="user_check_password" type="password" maxlength="15"
							placeholder="비밀번호 확인" style="margin-top: 10px;"
							oninput="onInputInvalid('passwordCheck')"> <span
							class="error_next_box" id="error_password" aria-live="assertive"></span>
					</div>
					<!--연락처-->
					<div class="join-user__items">
						<label>연락처</label>
						<div class="join-user__items--row"
							style="justify-content: space-between">
							<select id="user_phone_number_pre" style="min-width: 90px;"
								oninput="onInputInvalid('phoneNumber')">
								<option value="010">010</option>
								<option value="011">011</option>
								<option value="016">016</option>
							</select> - <input id="user_phone_number_in" style="max-width: 90px"
								maxlength="4" oninput="onInputInvalid('phoneNumber')"> -
							<input id="user_phone_number_post" style="max-width: 90px"
								maxlength="4" oninput="onInputInvalid('phoneNumber')">
						</div>
					...
					<div class="join-user__items">
						<label>주소</label> <input id="user_post" type="text"
							...
							id="user_addr" type="text" placeholder="주소" readonly
							style="margin-top: 10px;"> <br> <input
							id="user_addr_detail" type="text" placeholder="상세주소를 입력하세요."
							style="margin-top: -12px;"> <span class="error_next_box"
							id="error_address" aria-live="assertive"></span>
					</div>
					...
					<div class="join-user__items">
						...
						<ul class="list-group">
							<li class="list-group-item active" aria-current="true">반려동물
								등록 <a href="javascript:void(0)" class="addList" data-bs-toggle="modal"
								data-bs-target="#exampleModal">추가</a>
							</li>
							<li class="list-group-item">

								<div class="mypet_box1">
									<div>이름 : 구름이</div>
									<button onclick="rainbow_btn(this)">
					...
					<div class="join-user__items">
						<div class="join-user__items--row"
							...
							<button class="buttonOk button_class"
					...
					<div class="modal-body">
						...
						<div class="join-user__items">
							...
							<div class="join-user__items--row"
								...
								수컷입니다. <input type="radio" name="gender" value="female" />
								암컷입니다.
							</div>
						</div>
						<!--중성화수술은 했나요?-->
						<div class="join-user__items">
							...
							<div class="join-user__items--row"
								style="justify-content: space-between">
								<input type="radio" name="" value="yes" /> 수술완료. <input
									type="radio" name="" value="no" checked="checked" /> 안했습니다.
							</div>
						</div>
					</div>
